...
export default function SkillForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError(err.response?.data?.message || 'Failed to save skill')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            {isEditing ? 'Update the skill details below' : 'Fill in the details to add a new skill'}
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">Skill Information</h2>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Featured Skill</span>
              </label>
            </motion.div>
            ...
            >
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">Icon</h2>
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">
                  Icon Name <span className="text-gray-400 font-normal normal-case">(optional)</span>
                </label>
                <input
                  type="text"
                  value={form.icon}
