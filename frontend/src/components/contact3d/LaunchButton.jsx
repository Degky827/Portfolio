  ...
  return (
    <motion.div
      ...
      style={{
        left: x,
        top: y,
        background: `radial-gradient(circle, rgba(34,197,94,0.9), rgba(22,163,74,0.6))`,
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        background: canLaunch
          ? 'linear-gradient(165deg, rgba(34,197,94,0.15) 0%, rgba(34,197,94,0.08) 50%, rgba(22,163,74,0.06) 100%)'
          : 'rgba(0,0,0,0.04)',
        border: `1px solid ${canLaunch ? 'rgba(34,197,94,0.3)' : 'rgba(0,0,0,0.1)'}`,
        color: canLaunch ? 'rgba(255,255,255,0.95)' : 'rgba(0,0,0,0.35)',
        cursor: canLaunch ? 'pointer' : 'not-allowed',
        backdropFilter: 'blur(20px)',
        WebkitBackdropFilter: 'blur(20px)',
        boxShadow: canLaunch
          ? isHovered
            ? '0 12px 40px rgba(34,197,94,0.35), 0 0 30px rgba(34,197,94,0.15), inset 0 1px 0 rgba(255,255,255,0.12)'
            : '0 8px 30px rgba(34,197,94,0.25), inset 0 1px 0 rgba(255,255,255,0.08)'
    ...
    >
      ...
      <motion.div
        ...
        style={{
          padding: '1px',
          background: 'conic-gradient(from 0deg, rgba(34,197,94,0.55), rgba(22,163,74,0.25), rgba(34,197,94,0.55))',
          mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
          maskComposite: 'exclude',
          WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
          WebkitMaskComposite: 'xor',
          filter: canLaunch && isHovered ? 'drop-shadow(0 0 8px rgba(34,197,94,0.4))' : 'none',
        }}
      />
        ...
        <motion.div
          ...
          animate={{
            background: [
              ...
              'linear-gradient(90deg, transparent -50%, rgba(22,163,74,0.06) 0%, transparent 50%)',
            ],
          }}
        ...
        {ripples.map((ripple) => (
          <motion.div
            ...
            style={{
              left: ripple.x - 100,
              top: ripple.y - 100,
              background: 'radial-gradient(circle, rgba(34,197,94,0.3), rgba(22,163,74,0.15), transparent)',
            }}
          />
        ))}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {showFlash && (
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(34,197,94,0.3), rgba(22,163,74,0.2), rgba(34,197,94,0.3))',
        ...
        {isSubmitting ? (
          ...
          <>
            ...
            <motion.span
              ...
              className="relative"
              style={{
                filter: canLaunch ? 'drop-shadow(0 0 4px rgba(34,197,94,0.5))' : 'none',
              }}
            >
      ...
      <motion.div
        ...
        transition={{ duration: 0.4 }}
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(34,197,94,0.7), rgba(22,163,74,0.5), transparent)',
          boxShadow: canLaunch ? '0 0 12px rgba(34,197,94,0.4)' : 'none',
        }}
      />
    </motion.button>
  )
