  ...
  return (
    <motion.div
      ...
      style={{
        left: x,
        top: y,
        background: `radial-gradient(circle, rgba(99,102,241,0.9), rgba(99,102,241,0.6))`,
      ...
      {isActive && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: 'radial-gradient(circle, rgba(99,102,241,0.4), rgba(99,102,241,0.2), transparent)',
              filter: 'blur(4px)',
            }}
          />
        </motion.div>
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        background: canLaunch
          ? 'linear-gradient(165deg, rgba(99,102,241,0.2) 0%, rgba(99,102,241,0.12) 50%, rgba(129,140,248,0.08) 100%)'
          : 'var(--bg-secondary, rgba(0,0,0,0.04))',
        border: `1px solid ${canLaunch ? 'rgba(99,102,241,0.35)' : 'var(--border-default, rgba(0,0,0,0.1))'}`,
        color: canLaunch ? '#ffffff' : 'var(--text-secondary, rgba(0,0,0,0.35))',
        cursor: canLaunch ? 'pointer' : 'not-allowed',
        backdropFilter: 'blur(20px)',
        WebkitBackdropFilter: 'blur(20px)',
        boxShadow: canLaunch
          ? isHovered
            ? '0 12px 40px rgba(99,102,241,0.35), 0 0 30px rgba(99,102,241,0.12), inset 0 1px 0 rgba(255,255,255,0.12)'
    ...
    >
      ...
      <motion.div
        ...
        style={{
          padding: '1px',
          background: 'conic-gradient(from 0deg, rgba(99,102,241,0.5), rgba(99,102,241,0.2), rgba(99,102,241,0.5))',
        ...
        <motion.div
          ...
          animate={{
            background: [
              ...
              'linear-gradient(90deg, transparent -50%, rgba(99,102,241,0.06) 0%, transparent 50%)',
            ],
          }}
        ...
        {ripples.map((ripple) => (
          <motion.div
            ...
            style={{
              left: ripple.x - 100,
              top: ripple.y - 100,
              background: 'radial-gradient(circle, rgba(99,102,241,0.3), rgba(99,102,241,0.15), transparent)',
            }}
          />
        ))}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {showFlash && (
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(99,102,241,0.3), rgba(99,102,241,0.15), rgba(99,102,241,0.3))',
      ...
      <motion.div
        ...
        transition={{ duration: 0.4 }}
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(99,102,241,0.7), rgba(99,102,241,0.5), transparent)',
