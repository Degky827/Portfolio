...
const DEFAULT_TESTIMONIALS = [
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Sarah+Mitchell&background=6366f1&color=fff&size=128&bold=true',
  ...
  },
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=James+Chen&background=0ea5e9&color=fff&size=128&bold=true',
  ...
  },
  {
    ...
    relationship: 'Client',
    avatar: 'https://ui-avatars.com/api/?name=Maria+Rodriguez&background=ec4899&color=fff&size=128&bold=true',
  ...
  },
  {
    ...
    relationship: 'Supervisor',
    avatar: 'https://ui-avatars.com/api/?name=David+Park&background=10b981&color=fff&size=128&bold=true',
