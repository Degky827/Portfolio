...
import { RefreshCw, Palette, Save } from 'lucide-react'
...
export default function ThemeSettings() {
  ...
  return (
    <div>
      <PageHeader
        title="Appearance & Portfolio"
        subtitle="Customize your admin dashboard theme and public portfolio settings."
      />
      ...
      <div className="max-w-2xl space-y-6">
        ...
        >
          <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Dashboard Theme</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Choose between light, dark, or system theme for the admin dashboard. This preference is saved and persists across sessions.
          </p>
          <ThemeToggle />
        </motion.div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Configure portfolio display options and features for the public site.
              </p>
            </div>
          </div>
